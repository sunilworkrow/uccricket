...
const T20Series = () => {
  ...
  const [activeSubTab, setActiveSubTab] = useState('all'); // State to manage active tab
        ...
        <div id="tabs" className="my-4">
          <div className="flex text-1xl space-x-8 p-2 bg-[#ffffff] rounded-lg overflow-auto">
            ...
            <button
              ...
              className={`font-medium py-2 px-3 whitespace-nowrap ${activeTab === 'live' ? 'bg-[#1A80F8] text-white' : ''}`}
            >
              Schedule &amp; Results
            </button>
            <button
              onClick={(e) => handleTabClick(e, 'scorecard')}
              // className="font-medium py-2 px-3 whitespace-nowrap"
              className={`font-medium py-2 px-3 whitespace-nowrap ${activeTab === 'scorecard' ? 'bg-[#1A80F8] text-white' : ''}`}
            >
              Squads
            </button>
            <button
              onClick={(e) => handleTabClick(e, 'overs')}
              // className="font-medium py-2 px-3 whitespace-nowrap"
              className={`font-medium py-2 px-3 whitespace-nowrap ${activeTab === 'overs' ? 'bg-[#1A80F8] text-white' : ''}`}
            >
              Points Table
            </button>
            <button
              onClick={(e) => handleTabClick(e, 'points')}
              // className="font-medium py-2 px-3 whitespace-nowrap"
              className={`font-medium py-2 px-3 whitespace-nowrap ${activeTab === 'points' ? 'bg-[#1A80F8] text-white' : ''}`}
            >
              News
            </button>
            <button
              ...
              // className="font-medium py-2 px-3 whitespace-nowrap"
              className={`font-medium py-2 px-3 whitespace-nowrap ${activeTab === 'stats' ? 'bg-[#1A80F8] text-white' : ''}`}
            >
              Stats
            </button>
            <button
              ...
              // className="font-medium py-2 px-3 whitespace-nowrap"
              className={`font-medium py-2 px-3 whitespace-nowrap ${activeTab === 'stadiums' ? 'bg-[#1A80F8] text-white' : ''}`}
            >
              Stadiums
            </button>
          </div>
        ...
        <div id="tab-content">
          ...
          >
                  ...
                  <div className="rounded-lg bg-[#ffffff] p-4">
                      <form className="grid grid-cols-12 gap-4 items-end">
                          <div className="md:col-span-6 col-span-8">
                              <label for="most" className="block font-medium text-[#909090] mb-2">Team Vice</label>
                              <select id="most" className="border border-gray-300 rounded p-2 w-full">
                                  <option>South Africa Women</option>
                                  <option>Wickets</option>
                              </select>
                          </div>

                          <div className="md:col-span-6 col-span-4 text-right">
                              <button
                                  className="bg-blue-900 text-white font-semibold py-[10px] px-4 rounded hover:bg-blue-800">Clear
                                  Filter</button>
                          </div>
                      </form>
                  </div>
            ...
            <div className="md:grid grid-cols-12 gap-4">
              ...
              <div className="lg:col-span-8 md:col-span-7">
                <div id="aus-team" className="team-content">
                  <p>I am Afg Team</p>
                </div>
                <div id="south-team" className="team-content hidden">
          ...
          >
            <div className="md:grid grid-cols-12 gap-4">
              ...
              <div className="lg:col-span-9 md:col-span-8">
                ...
                <div id="highest-scores" className="state-content">
                  sdfuysdfytsd
                </div>
                <div className="rounded-lg bg-[#ffffff] p-4 mb-4">
                  <h3 className="text-1xl font-semibold mb-2 pl-[7px] border-l-[3px] border-[#229ED3]">
            ...
            {/* Stadiums Tab */}
            <div id="stadiums" className="tab-content hidden">
              dfghjk
            </div>
          </div>
