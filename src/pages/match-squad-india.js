                        ...
                        <div className="lg:col-span-4 md:col-span-5">
                            <div className="rounded-lg p-2 mb-4 bg-[#ffffff]">
                                <div id="team-buttons" className="">
                                    <Link href="/match-squad">
                                        <button
                                            className="team-btn border-b px-2 mb-1 py-3 w-full text-[#394351] hover:bg-[#eaeaea] rounded-md font-medium flex items-center"
                                    ...
                                    <Link href="/match-squad-india">
                                        <button
                                            className="team-btn px-2 py-3 w-full text-[#394351] font-medium bg-[#eaeaea] rounded-md flex items-center"
...
export default MatchSquadIndia;
